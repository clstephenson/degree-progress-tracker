 ...
 */
public class UpdateDataAsyncTask<T extends BaseModel> extends AsyncTask<Pair<T, OnAsyncTaskResultListener>, Void, AsyncTaskResult> {
     ...
     */
    public UpdateDataAsyncTask(Class<? extends BaseDao> daoClass, BaseDao dao) {
    ...
    protected void onPostExecute(AsyncTaskResult taskResult) {
        listener.onAsyncUpdateDataCompleted(result);
    }
}
